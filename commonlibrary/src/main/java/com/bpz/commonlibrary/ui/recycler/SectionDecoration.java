...
public class SectionDecoration<T> extends RecyclerView.ItemDecoration {
    ...
    public SectionDecoration(List<T> dataList, Context context, DecorationCallback decorationCallback) {
        ...
        textPaint.setTextSize(DimensionUtil.dip2px(context, 14));
