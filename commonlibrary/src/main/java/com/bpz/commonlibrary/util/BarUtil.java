...
public final class BarUtil {
     ...
     */
    public static boolean isStatusBarVisible(@NotNull Activity activity) {
     ...
     * @param view view
     */
    public static void addMarginTopEqualStatusBarHeight(@NotNull View view) {
    ...
    public static int getStatusBarHeight() {
        Resources resources = LibApp.mContext.getResources();
     ...
     * @param view view
     */
    public static void subtractMarginTopEqualStatusBarHeight(@NotNull View view) {
        Object haveSetOffset = view.getTag(TAG_OFFSET);
        if (haveSetOffset == null || !(Boolean) haveSetOffset) return;
        MarginLayoutParams layoutParams = (MarginLayoutParams) view.getLayoutParams();
        layoutParams.setMargins(layoutParams.leftMargin,
     ...
     */
    public static void setStatusBarColor(@NotNull Activity activity,
                                         @ColorInt int color,
    ...
    private static void hideAlphaView(@NotNull Activity activity) {
    ...
    private static void hideColorView(@NotNull Activity activity) {
        ViewGroup decorView = (ViewGroup) activity.getWindow().getDecorView();
     ...
     * @param color         状态栏颜色值
     */
    public static void setStatusBarColor(@NotNull View fakeStatusBar,
                                         @ColorInt int color) {
     ...
     * @param alpha         状态栏透明度
     */
    public static void setStatusBarAlpha(@NotNull View fakeStatusBar,
                                         @IntRange(from = 0, to = 255) int alpha) {
        /*if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;*/
        fakeStatusBar.setVisibility(View.VISIBLE);
        transparentStatusBar((Activity) fakeStatusBar.getContext());
     ...
     * @param isTop         drawerLayout 是否在顶层
     */
    public static void setStatusBarColor4Drawer(@NotNull Activity activity,
                                                @NotNull DrawerLayout drawer,
                                                @NotNull View fakeStatusBar,
                                                @ColorInt int color,
                                                @IntRange(from = 0, to = 255) int alpha,
                                                boolean isTop) {
        /*if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;*/
     ...
     * @param isTop         drawerLayout 是否在顶层
     */
    public static void setStatusBarAlpha4Drawer(@NonNull Activity activity,
                                                @NonNull DrawerLayout drawer,
                                                @NonNull View fakeStatusBar,
                                                boolean isTop) {
     ...
     * @param isTop         drawerLayout 是否在顶层
     */
    public static void setStatusBarAlpha4Drawer(@NotNull Activity activity,
                                                @NotNull DrawerLayout drawer,
                                                @NotNull View fakeStatusBar,
                                                @IntRange(from = 0, to = 255) final int alpha,
                                                boolean isTop) {
    ...
    private static void invokePanels(String methodName) {
        try {
            ...
            Object service = LibApp.mContext.getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = LibApp.mContext.getResources();
    ...
    public static void setNavBarImmersive(@NotNull Activity activity) {
        View decorView = activity.getWindow().getDecorView();
        activity.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS);
     ...
     * @return {@code true}: 可见<br>{@code false}: 不可见
     */
    public static boolean isNavBarVisible(@NotNull Activity activity) {
