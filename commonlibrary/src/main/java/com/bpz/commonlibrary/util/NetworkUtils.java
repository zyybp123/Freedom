...
public final class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) LibApp.mContext.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) LibApp.mContext.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) LibApp.mContext.getSystemService(Context.WIFI_SERVICE);
